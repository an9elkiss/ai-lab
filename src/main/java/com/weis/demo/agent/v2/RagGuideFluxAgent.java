...
public interface RagGuideFluxAgent {
    ...
    String SYSTEM_MESSAGE = """
          ...
          **输出格式：**
          你的回复...
          <redefined_reply>预制回答一</redefined_reply>
          <redefined_reply>预制回答二</redefined_reply>
          
          **输出示例：**
          为了给您推荐最合适的款式，请问您是为自己选购吗？以及大概什么预算范围呢？
          <redefined_reply>自己穿，预算1000以内</redefined_reply>
          <redefined_reply>送人，预算2000左右</redefined_reply>
